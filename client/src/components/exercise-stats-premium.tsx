      ...
      <CardContent className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-3 border border-gray-200 dark:border-gray-800">
            ...
            <div className="text-lg font-bold text-gray-900 dark:text-white">{totalWorkouts}</div>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-3 border border-gray-200 dark:border-gray-800">
            ...
            <div className="text-lg font-bold text-gray-900 dark:text-white">{totalSets}</div>
          </div>
        </div>
        ...
        {history.length > 0 && (
          <div className="pt-2 border-t border-gray-200 dark:border-gray-800">
            <div className="text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">Recent Sessions</div>
  ...
  const premiumContent = (
    <Card className="border-2 border-amber-200 dark:border-amber-800 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20">
      ...
      <CardContent className="space-y-3">
        {/* Quick Stats Grid */}
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white/60 dark:bg-gray-900/40 rounded-lg p-3 border border-amber-200 dark:border-amber-800">
            <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400 mb-1">
              <Calendar className="h-3 w-3" />
              Workouts
            </div>
        ...
        {bestSet && (
          <div className="bg-white/60 dark:bg-gray-900/40 rounded-lg p-3 border border-amber-200 dark:border-amber-800">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-bold text-amber-600 dark:text-amber-400">{bestSet.weight}</span>
              <span className="text-sm text-gray-600 dark:text-gray-400">lbs × {bestSet.reps} reps</span>
            </div>
